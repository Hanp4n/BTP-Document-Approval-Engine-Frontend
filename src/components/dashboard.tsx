...
export function Dashboard() {
  ...
  const handleSubmit = () => {
    const approvalLevel = formData.amount > 10000 ? 3 : formData.amount > 5000 ? 2 : 1
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="proveedor">Proveedor (Supplier)</Label>
              <Input
                id="proveedor"
            ...
            <div className="grid gap-2">
              <Label htmlFor="importe">Importe (Amount)</Label>
              <Input
                id="importe"
                type="number"
            ...
            <div className="grid gap-2">
              <Label htmlFor="fecha">Fecha (Date)</Label>
              <Input
                id="fecha"
                type="date"
                value={formData.date}
            ...
            <div className="grid gap-2">
              <Label htmlFor="estado">Estado (Status)</Label>
              {isEditMode ? (
                <Select
